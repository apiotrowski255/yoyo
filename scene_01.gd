...
func _ready():
	...
	if GlobalVariables.test == 0:
		...
		$checkpoint_areas/CollisionShape2D.disabled = true
		...
		$checkpoint_areas/CollisionShape2D.disabled = true
		$checkpoint_areas/CollisionShape2D2.disabled = true
	elif GlobalVariables.test == 3:
		$Player.global_position = Vector2(3768, 128)
		$checkpoint_areas/CollisionShape2D.disabled = true
		$checkpoint_areas/CollisionShape2D2.disabled = true
		$checkpoint_areas/CollisionShape2D3.disabled = true
	elif GlobalVariables.test == 4:
		$Player.global_position = Vector2(4744, 112)
		$checkpoint_areas/CollisionShape2D.disabled = true
		$checkpoint_areas/CollisionShape2D2.disabled = true
		$checkpoint_areas/CollisionShape2D3.disabled = true
		$checkpoint_areas/CollisionShape2D4.disabled = true
		...
		$checkpoint_areas/CollisionShape2D3.disabled = true
		$checkpoint_areas/CollisionShape2D4.disabled = true
		$checkpoint_areas/CollisionShape2D5.disabled = true
		...
		$checkpoint_areas/CollisionShape2D4.disabled = true
		$checkpoint_areas/CollisionShape2D5.disabled = true
		$checkpoint_areas/CollisionShape2D6.disabled = true
		...
		$checkpoint_areas/CollisionShape2D5.disabled = true
		$checkpoint_areas/CollisionShape2D6.disabled = true
		$checkpoint_areas/CollisionShape2D7.disabled = true
